...
export default function BookingPage() {
  ...
  const confirmMutation = useMutation({
    ...
    onError: (e: any) => setError(e?.message ?? 'Erro ao confirmar reserva.'),
  })
  ...
  const calDays   = Array.from({ length: firstDay - 1 }, () => null).concat(
  ...
  return (
    <div className="min-h-screen relative flex items-start justify-center pt-24 pb-16 px-4">
      ...
      <div className="w-full max-w-xl">
        ...
        {/* Card */}
        <div className="bg-gray-900/95 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-gray-700 overflow-hidden flex-shrink-0">
                    {b.photo_url
                      ...
                      : <span className="w-full h-full flex items-center justify-center
                                         text-white font-bold">{b.name.charAt(0)}</span>}
                  </div>
          ...
          {step === 4 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  placeholder="Ex: cabelo mais curto nos lados..."
                  value={booking.notes}
              ...
              <p className="text-xs text-gray-600">
                ...
                <a href="/infos/booking-conditions" className="underline hover:text-gray-400">
                  Condições de Reserva
                </a>{' '}e{' '}
                <a href="/infos/privacy" className="underline hover:text-gray-400">
                  Política de Privacidade
                </a>.
              </p>
              {error && (
                <p className="text-sm text-red-400 bg-red-950/50 border border-red-800/50
